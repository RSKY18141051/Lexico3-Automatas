...
/*
Requerimiento 1: Levantar la excepcion en caso de error e identificar el tipo de error.
Requerimiento 2: Indicar en que linea y caracter se encuentra el error.
Requerimiento 3: Agregar el token { y } en la matriz trand6x. (Agregar las columnas de { y }).
Requerimiento 4: Agregar los comentarios de linea y multilinea. (Agregar la columna #10).
Requerimiento 5: Grabar en el archivo .log los errores lexicos.
Completados: R3(25/03),R4(28/03|modificacion 12/04),R1(08/04|correccion 12/04),R5(12/04),R2(14/04)
 */
